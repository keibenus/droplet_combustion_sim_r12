...
def _interface_energy_residual_full(T_s_guess: float,
    ...
    try:
        ...
        Y_f_eq, Y_eq = calculate_fuel_mass_fraction_surf(T_s_phys, P, gas_props, liquid_props)
...
# <<< 追加: brentq用のラッパー関数 >>>
def _residual_wrapper_for_solver(T_s_guess, T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl):
    """Wrapper that calls _interface_energy_residual_full and returns only the residual."""
    residual, _, _, _ = _interface_energy_residual_full(T_s_guess, T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl)
    return residual
...
def solve_interface_conditions(
    ...
    try:
        ...
        res_low, _, _, _ = _interface_energy_residual_full(T_lower_bound, T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl)
        res_high, _, _, _ = _interface_energy_residual_full(T_upper_bound, T_l_node_last, T_g_node0, Y_g_node0, P, R, r_l_node_last_center, r_g_node0_center, gas_props, liquid_props, Nl)
    ...
    _, Y_eq_final = calculate_fuel_mass_fraction_surf(T_s_final, P, gas_props, liquid_props)
