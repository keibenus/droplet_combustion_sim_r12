...
# --- Logging Options ---
LOG_LEVEL = 0 # 0: Basic, 1: Info (Iteration details), 2: Debug (More verbose)
TERMINAL_OUTPUT_INTERVAL_STEP = 50 # Steps (Interval for printing status for LOG_LEVEL 0/1)
# --- Output Options ---
OUTPUT_DIR = 'results_r12' # Changed output dir name
...
# --- Grid Parameters ---
NL = 20             # Number of liquid grid points (cell centers)
...
T_END = 2e-3 # s (Simulation end time, 延長)
